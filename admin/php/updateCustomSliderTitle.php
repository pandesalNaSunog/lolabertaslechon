...
if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest'){
    ...
    $con = connect();
        ...
        if($mainRow = $main->fetch_assoc()){
            $query = "UPDATE custom_slider_title SET slider_title = '$title',updated_at='$today'";
        }else{
            $query = "INSERT INTO `custom_slider_title`(`slider_title`,`created_at`,`updated_at`) VALUES ('$title','$today','$today');";
        }
